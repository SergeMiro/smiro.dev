...
function boot(container) {
  ...
  const C = {
    en: {
      ...
      term: [
        '$ npm run build',
        '▲ bundling 7 years in IT into one page…',
        '✓ 0 red flags found',
        '✓ ego minified',
        '✓ built in 0.42s — opening offer…',
      ],
      url: 'smiro.dev/your-best-hire',
      big: 'Ready to give me that opportunity? 😉',
